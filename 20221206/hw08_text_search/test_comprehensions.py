...
class TestComprehensions(unittest.TestCase):
    ...
    def setUp(self):
        self.numberList = [-2, -3, 4, 5, 7, 43, 2345,
                           1343, 13, 40, 24, 221, 5942, 7, 9, 113]
        self.wordList = "All my words are unique and therefore not duplicated".split()

    def test_multiply_by(self):
        expected = [4, 6, -8, -10, -14, -86, -4690, -
                    2686, -26, -80, -48, -442, -11884, -14, -18, -226]
    ...
    def test_word_to_length(self):
        expected = {'All': 3, 'words': 5, 'are': 3, 'unique': 6,
                    'and': 3, 'therefore': 9, 'not': 3, 'duplicated': 10}
