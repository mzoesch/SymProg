...
def hello_semester():
    """ Print the string 'Welcome to "Symbolische Programmierung" WS 21/22'.
    >>> hello_semester()
    Welcome to "Symbolische Programmierung" WS 21/22
    """
    return print('Welcome to "Symbolische Programmierung" WS 21/22')
...
def happy_birthday(name, age):
    ...
    """
    return print("Happy " + str(age) + "th birthday, " + name + "!")
...
def replace_elements(list_a, replacement_indices, new_value):
    ...
    """
    return [new_value if i in replacement_indices else list_a[i] for i in range(len(list_a))]
...
def long_strings(string_list, max_length):
    ...
    """
    return [len(string) > max_length for string in string_list]
...
def print_squares(list_a):
    ...
    36
    """
    return [print(i ** 2) for i in list_a]
...
def count_to_k(k):
    ...
    >>> count_to_k(0)
    """
    return [print(i) for i in range(-1, k - 1, -1)] if k < 0 else [print(i) for i in range(0, k)]
