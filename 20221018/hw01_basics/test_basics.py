...
class TestBasics(TestCase):
    ...
    def test_hello_semester(self):
        ...
        self.assert_stdout(hello_semester, None, None,
                           "Welcome to \"Symbolische Programmierung\" WS 21/22\n")
    ...
    def test_happy_birthday(self):
        ...
        self.assert_stdout(happy_birthday, "Peter", "17",
    ...
    def test_swap_half(self):
        ...
        self.assertEqual(swap_half(self.listOne), [
    ...
    def test_replace_elements(self):
        ...
        result.
        """
        self.assertEqual(replace_elements([1, 2, 3, 4, 5, 6, 7, 8], [
                         0, 4, 3], 0), [0, 2, 3, 0, 0, 6, 7, 8])
    ...
    def test_long_strings(self):
        ...
        """
        self.assertEqual(long_strings(listOne, 5), [
    ...
    def test_print_squares(self):
        ...
        self.assert_stdout(print_squares, self.listThree,
                           None, "25\n16\n64\n36\n")
